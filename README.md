...
--------------------------------------------------------------------------
## Created a dockerfile to build the nextjs source code into a repository
--------------------------------------------------------------------------
...
- [docker](/examples/cms-wordpress)
- [Github Actions](/examples/cms-datocms)
- [AWS](/examples/cms-sanity)
- [Elastic Container Registry](/examples/cms-takeshape)
- [Elastic Container Services](/examples/cms-prismic)
